...
import { FaHome, FaSearch, FaPhone, FaUser, FaBars } from 'react-icons/fa'
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Basera</h1>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#search" className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 relative group">
              Search
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-600 to-indigo-600 group-hover:w-full transition-all duration-300"></span>
            </a>
            <a href="#listings" className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 relative group">
              Listings
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-600 to-indigo-600 group-hover:w-full transition-all duration-300"></span>
            </a>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-6 pb-4 border-t border-gray-200 bg-white/95 backdrop-blur-md rounded-xl shadow-lg">
            <div className="flex flex-col space-y-4 pt-4 px-4">
              <a href="#home" className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 py-2">Home</a>
              <a href="#search" className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 py-2">Search</a>
              <a href="#listings" className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 py-2">Listings</a>
              <a href="#about" className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 py-2">About</a>
              <a href="#contact" className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 py-2">Contact</a>
